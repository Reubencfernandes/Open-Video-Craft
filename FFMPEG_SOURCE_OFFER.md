...
Open Video Craft 1.0.2 for macOS and Windows includes FFmpeg executables under
...
- `Open-Video-Craft-1.0.2-Windows-FFmpeg-Build-Sources.tar.gz` contains the
  exact BtbN build scripts, FFmpeg source revision, manifests, checksums, and
  rebuild notes.
- `Open-Video-Craft-1.0.2-Windows-FFmpeg-Dependency-Sources.tar` contains the
